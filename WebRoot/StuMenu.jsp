        ...
        <div class="page-content">
          <div class="content">
            ...
            <blockquote class="layui-elem-quote">
                欢迎<%=request.getAttribute("StuName")%>同学使用课程注册系统！现在是北京时间<font><span id="nowDateTimeSpan"></span></font> 
                <%
                 if(request.getAttribute("BIR").equals("YES")){
                %>
                	<br><font color="red"> 祝<%=request.getAttribute("StuName")%>同学<%=request.getAttribute("BIRY")%>岁生日快乐！</font>
                <%
                 }
                %>
            </blockquote>
