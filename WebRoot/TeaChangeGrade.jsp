            ...
            <form class="layui-form" action="ChangeGradeServlet?username=<%=request.getParameter("username") %>" method="post">
			   ...
			   <input type="hidden" name="SName" value=<%=request.getParameter("SName")%>>
                <div class="layui-form-item">
                    ...
                    <label for="L_repass" class="layui-form-label">
                        <span class="x-red"></span><%= request.getParameter("SName")%>
                    </label>
                </div>
                <div class="layui-form-item">
                    ...
                    <label for="L_repass" class="layui-form-label">
                        <span class="x-red"></span><%= request.getParameter("SID")%>
                    </label>
                </div>
                <div class="layui-form-item">
                    <label for="L_repass" class="layui-form-label">
                    ...
                    {
                    	System.out.println("TeaChageGrade.jsp,grade==null");
                    }
                  ...
                  <input id="L_count" name="grade"  required="" lay-verify="required"
                    ...
                    <input id="L_count" name="grade" value=<%= request.getParameter("grade")%> required="" lay-verify="required"
                        autocomplete="off" class="layui-input">
                        <%} %>
                    </div>
