	...
	<div class="left-nav">
        ...
        <div class="page-content">
          <div class="content">
            ...
            <form class="layui-form" action="AddStuServlet" method="post">
				...
				<div class="layui-form-item">
                    ...
                    <div class="layui-input-inline"> 
					  <input type="text" class="layui-input" id="L_gradDate" name="gradDate">
					</div>
                    <script src="./lib/layui/layui.js"></script>
					<script>
						layui.use('laydate', function(){
                ...
                <div class="layui-form-item">
                    ...
                    <button class="btn btn-warning pull-right" lay-submit lay-filter="addStu"  type="submit">
                        增加学生
                    </button>
                </div>
            </form>
