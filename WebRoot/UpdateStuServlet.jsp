	...
	<div class="left-nav">
        ...
        <div class="page-content">
          <div class="content">
            ...
            <form class="layui-form" action="UpdateStuServlet" method="post" name="myForm">
            	 <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        autocomplete="off" class="layui-input" value="${result.getSID()}">
                    </div>
                </div>
                <div class="layui-form-item">
				...
				<div class="layui-form-item">
				    ...
				    <div class="layui-input-block" style="width: 150px;">
				       ...
				       %>
				        ...
				        <%@ page import="com.*"%>
				        <%Student stu = (Student)request.getAttribute("result"); %>
						<% for(DepInfo item:depList){
						     %>
						         <option value=<%=item.getDID()%> <%if (stu != null && stu.getDID()==item.getDID()) { %> selected<% } %>><%=item.getName()%></option>
						    <%
						}
						%>
				      </select>
				...
				<div class="layui-form-item">
				    ...
				    <div class="layui-input-block" style="width: 150px;">
				      <select name="status" >
				        ...
				        <option value="本科生"<%if (stu != null && stu.getStatus().equals("本科生")) { %> selected<% } %>>本科生</option>
				        <option value="研究生"<%if (stu != null && stu.getStatus().equals("研究生")) { %> selected<% } %>>研究生</option>
				      </select>
				    </div>
				</div>
				<div class="layui-form-item">
                    <label for="L_gradDate" class="layui-form-label">
                        <span class="x-red">*</span>毕业日期
                    </label>
                    <div class="layui-input-inline"> 
					  <input type="text" class="layui-input" id="L_gradDate" name="gradDate" value="${result.getGradDate()}">
					</div>
                    <script src="./lib/layui/layui.js"></script>
					<script>
						layui.use('laydate', function(){
