	...
	<div class="left-nav">
        ...
        <div class="page-content">
          <div class="content">
            ...
            <form class="layui-form" action="FindorDeleteDepServlet" method="post">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        autocomplete="off" class="layui-input" value="${depInfo.getDID()}" >
                    </div>
                </div>
                <div class="layui-form-item">
				...
				<tbody>
				  <%
				  if(request.getAttribute("depInfo")!=null){
					  DepInfo dep=(DepInfo)request.getAttribute("depInfo");
					  DepartOP depOp = new DepartOP();
                        ...
                        <th>
                        	<form action="FindorDeleteDepServlet" method="post">
